...
angular.module('bahmni.common.checkboxAttributeTypes', []).directive('checkboxAttributeTypes', [function () {
    return {
        scope: {
            targetModel: '=',
            attribute: '=',
        ...
        templateUrl: '../common/attributeTypes/views/checkboxAttributeInformation.html',
        restrict: 'E',
